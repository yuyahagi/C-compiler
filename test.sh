...
try 3 'main() { int a; a=1; return a+2; }'
try 3 'main() { int x; x = 1; x = x + 2; return x; }'
try 4 'main() { int _long_variable_1_; _long_variable_1_ = 2; return _long_variable_1_ * 2; }'
try 5 'main() { int foo; int bar; int baz; foo=1; bar=baz=foo+1; return foo+bar*baz; }'
try 1 'main() { int foo; foo = 0; return (foo = foo + 3) == 3; }'
...
try 0 'main() { return 1 <= 10 != 10 >= 1; }'
try 1 'main() { return 1 <= 10 == 10 >= 1; }'
try 2 'main() { int i; int j; i = j = 2+3*4 == 14; return i + j; }'
try 0 'main() { int i; int j; i = j = 2+3*4 != 14; return i + j; }'
...
try 21 'main() { int x; x = 2; return func2(3-x, 4/x); }'
try 0 'main() { return func8(1, 2, 3, 4, 5, 6, 7, 8) - 87654321; }'
try 0 'main() { int x; x = 2; return func8(1, (x), x+1, x*2, 5, 2*(x+1), 3*x+1, 8) - 87654321; }'
...
try 14 '
foo(x) { int a; a = 3; return a * x; }
main() { int b; b = 2; return foo(4) + b; }'
...
try 0 'main() { int x; int y; x = 3; if (x + 1 != 2 * 2) y = 1; else y = 0; if (y) return 1; else return 0; }'
try 1 'main() { int x; int y; x = 3; if (x + 1 == 2 * 2) y = 1; else y = 0; if (y) return 1; else return 0; }'

try 15 '
add_upto(x) { if (x == 1) return x; else return x + add_upto(x-1); }
main() { return add_upto(5); }'

try 2 'main() { int x; x = 0; if (1) { x = 1; x = x * 2; } return x; }'
...
try 1 'main() { int x; x = 1; while (0) x = 0; return x; }'
try 5 'main() { int i; i = 0; while (i < 5) i = i + 1; return i; }'
try 10 'main() { int i; int sum; i = 0; sum = 0; while (i < 5) { sum = sum + i; i = i + 1; } return sum; }'
try 5 'main() { int i; i = 0; while ((i = i + 1) < 5) ; return i;}'

try 10 'main() { int sum; int i; sum = 0; for (i = 0; i < 5; i = i + 1) sum = sum + i; return sum; }'
try 10 'main() { int sum; int i; sum = 0; for (i = 4; i >= 0; i = i - 1) sum = sum + i; return sum; }'
try 5 'main() { int i; i = 0; for ( ; i < 5; i = i + 1) ; return i; }'
try 5 'main() { int i; i = 5; for ( ; i < 5; i = i + 1) ; return i; }'
try 5 'main() { int i; i = 0; for ( ; i < 5; ) i = i + 1; return i; }'
try 34 '
main() {
